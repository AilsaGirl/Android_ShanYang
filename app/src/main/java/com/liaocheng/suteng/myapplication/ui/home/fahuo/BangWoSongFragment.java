...
public class BangWoSongFragment extends BaseFragment {
    ...
    public int getLayoutId() {
        return R.layout.fragment_bangwosong;
    }

    int mId;

    @SuppressLint("ValidFragment")
    public BangWoSongFragment(int id) {
        mId = id;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvFaDiZhiChangYong:
                ...
                addressModel.is_new_address = 0;
                intent.putExtra("address_data", addressModel);
                intent.putExtra("tip", 31);//31  帮我送跳地址  选择地址后跳选择收货地址
                mContext.startActivity(intent);
                break;
            case R.id.linShou:
                if (System.currentTimeMillis() - mLasttime < 1700)//防止快速点击操作
            ...
            case R.id.tvShouDiZhiChangYong:
                ...
                intent.putExtra("tip", 32);//32  帮我送跳地址  选择地址后直接下单
                mContext.startActivity(intent);
