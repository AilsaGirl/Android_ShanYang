...
public class FaHuoPresenter extends RxPresenter<FaHuoContact.View> implements FaHuoContact.Presenter{
...
//        }
    ...
    @Override
    public void detail(String id, String jingdu,  String weidu) {
