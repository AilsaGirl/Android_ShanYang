package com.liaocheng.suteng.myapplication.util.mapUtil;
...
public class AmUtil {
    ...
    public static String getFriendlyLength(int lenMeter) {
        ...
        if (lenMeter > 1000) {
            ...
            return dstr + CUtil.Kilometer;
        }

        if (lenMeter > 100) {
            int dis = lenMeter / 50 * 50;
            return dis + CUtil.Meter;
        }
    ...
    public static ArrayList<LatLng> convertArrList(List<LatLonPoint> shapes) {
        ...
        for (LatLonPoint point : shapes) {
            LatLng latLngTemp = AmUtil.convertToLatLng(point);
