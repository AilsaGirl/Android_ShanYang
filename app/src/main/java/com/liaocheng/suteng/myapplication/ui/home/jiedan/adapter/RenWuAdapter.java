...
public class RenWuAdapter extends RecyclerView.Adapter<RenWuAdapter.ViewHolder> {
    ...
    public RenWuAdapter(Context context, int type,FollowClickListener mListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_renwu, parent, false));
    }
...
//                holder.tvMsg.setText(ordersModel.description + "");
            ...
            holder.tvBackDaTing.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    mListener.onBtnClick("1",ordersModel.orderCode);
                }
            });
            holder.tvBackFaDanRen.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    mListener.onBtnClick("2",ordersModel.orderCode);
                }
            });
            holder.tvQuHuo.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    mListener.onBtnClick("0",ordersModel.orderCode);
                }
            });
